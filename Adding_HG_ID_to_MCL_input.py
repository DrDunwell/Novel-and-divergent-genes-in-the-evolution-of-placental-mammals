...
if __name__ == "__main__":
	#change these names to match those generated by running mcxdeblast and MCL respectively.
	MCL_out_put_2_cluster_ID_addition3("Output Of mcxdeblast","Output of MCL")
